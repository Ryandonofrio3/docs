...
```python
from raindrop import Raindrop  # Not 'from rd_mini'
```
...
1. Check the [GitHub issues](https://github.com/ryandonofrio/rd-mini/issues)
2. Enable `debug: true` and check logs
3. Open an issue with:
   - SDK version (`npm list rd-mini` or `pip show rd-mini`)
